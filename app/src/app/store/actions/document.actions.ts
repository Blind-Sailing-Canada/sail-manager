...
export const fetchDocument = createAction(DOCUMENT_ACTION_TYPES.FETCH_ONE, props<{ document_id: string }>());
...
export const updateDocument = createAction(
  DOCUMENT_ACTION_TYPES.UPDATE, props<{ document_id: string; document: Partial<Document>; notify?: boolean }>());

...
export const deleteSailCategory = createAction(SAIL_CATEGORY_ACTION_TYPES.DELETE, props<{ sail_category_id: string; notify?: boolean }>());
...
export const putSailCategory = createAction(
  SAIL_CATEGORY_ACTION_TYPES.PUT_ONE, props<{ sail_category_id: string; category: SailCategory }>());
export const removeSailCategory = createAction(SAIL_CATEGORY_ACTION_TYPES.REMOVE_ONE, props<{ sail_category_id: string }>());

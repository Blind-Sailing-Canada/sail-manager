...
export const updateBoat = createAction(BOAT_ACTION_TYPES.UPDATE, props<{ id: string; boat: Boat }>());
...
export const putBoat = createAction(BOAT_ACTION_TYPES.PUT_ONE, props<{ id: string; boat: Boat }>());

...
export const editSailManifestRoute = (sailId: string) => `${FULL_ROUTES.EDIT_SAIL_MANIFEST}/${sailId}`;
...
export const viewSailChecklistRoute = (sailId: string) => `${FULL_ROUTES.VIEW_SAIL_CHECKLIST}/${sailId}`;

...
export enum FullRoutes {
  ...
  MAINTENACE = ROOT + RootRoutes.MAINTENANCE,
  ...
  SAIL_PEOPLE_MANIFEST = ROOT + RootRoutes.SAIL_PEOPLE_MANIFEST,
  ...
  CREATE_MAINTENANCE = MAINTENACE + SEPARATOR + SubRoutes.CREATE_MAINTENANCE,
  ...
  EDIT_MAINTENANCE = MAINTENACE + SEPARATOR + SubRoutes.EDIT_MAINTENANCE,
  ...
  EDIT_SAIL_PEOPLE_MANIFEST = SAIL_PEOPLE_MANIFEST + SEPARATOR + SubRoutes.EDIT_SAIL_PEOPLE_MANIFEST,
  ...
  LIST_CLICNICS = CLINICS + SEPARATOR + SubRoutes.LIST_CLINICS,
  ...
  RESOLVE_MAINTENANCE = MAINTENACE + SEPARATOR + SubRoutes.RESOLVE_MAINTENANCE,
  ...
  VIEW_MAINTENANCE = MAINTENACE + SEPARATOR + SubRoutes.VIEW_MAINTENANCE,
  ...
  VIEW_SAIL_PEOPLE_MANIFEST = SAIL_PEOPLE_MANIFEST + SEPARATOR + SubRoutes.VIEW_SAIL_PEOPLE_MANIFEST,
...
export const editSailPeopleManifestRoute = (sailChecklistId: string) => `${FullRoutes.EDIT_SAIL_PEOPLE_MANIFEST}/${sailChecklistId}`;
...
export const listClinicsRoute = () => `${FullRoutes.LIST_CLICNICS}`;
...
export const maintenanceRoute = FullRoutes.MAINTENACE;
...
export const viewSailPeopleManifestRoute = (sailChecklistId: string) => `${FullRoutes.VIEW_SAIL_PEOPLE_MANIFEST}/${sailChecklistId}`;
